...
reports, aged dues, printable GST-ready receipts) and P3 (attendance — the register, plus the daily
at-risk list on a per-member baseline) all shipped 2026-07-26. **P4 (renewals pipeline +
click-to-WhatsApp composer) is next.**
